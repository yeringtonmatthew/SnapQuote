...
export default function ClientProfileContent({ client, quotes, totalRevenue, totalQuoted }: Props) {
  ...
  return (
    <>
      {/* Header */}
      <header className="relative bg-gradient-to-br from-gray-900 to-gray-800 dark:from-gray-900 dark:to-black px-5 pt-14 lg:pt-8 pb-10">
      ...
      <div className="mx-auto max-w-5xl px-5 -mt-4">
        <div className="grid grid-cols-5 gap-2">
          {/* Call */}
          {client.phone ? (
            <a href={`tel:${client.phone}`} className="flex flex-col items-center gap-1.5 rounded-2xl bg-white dark:bg-gray-900 pt-5 pb-3 ring-1 ring-black/[0.04] dark:ring-white/[0.06] shadow-sm press-scale">
          ...
          {/* Text */}
          {client.phone ? (
            <a href={`sms:${client.phone}`} className="flex flex-col items-center gap-1.5 rounded-2xl bg-white dark:bg-gray-900 pt-5 pb-3 ring-1 ring-black/[0.04] dark:ring-white/[0.06] shadow-sm press-scale">
