          ...
          <div className="space-y-2">
            ...
            {invoice.customer_phone && (
              <div className="flex items-center gap-2">
                ...
                <a href={`tel:${invoice.customer_phone}`} className="text-[14px] text-blue-600 dark:text-blue-400">
                  {invoice.customer_phone}
                </a>
              </div>
            )}
            {invoice.customer_email && (
              <div className="flex items-center gap-2">
                ...
                <a href={`mailto:${invoice.customer_email}`} className="text-[14px] text-blue-600 dark:text-blue-400">
                  {invoice.customer_email}
                </a>
              </div>
            )}
            {invoice.job_address && (
              <div className="flex items-center gap-2">
                ...
                <p className="text-[14px] text-gray-900 dark:text-gray-100">{invoice.job_address}</p>
              </div>
            )}
          </div>
        </div>
