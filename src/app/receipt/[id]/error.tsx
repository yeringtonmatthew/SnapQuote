...
export default function ReceiptError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-[#f5f5f7] px-6">
      <div className="text-center">
        ...
        <p className="mt-2 text-[14px] text-gray-500">We couldn't load this receipt. Please try again.</p>
        <button
          onClick={reset}
