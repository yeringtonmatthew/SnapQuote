    ...
    <div className="flex min-h-dvh flex-col items-center justify-center bg-[#f2f2f7] dark:bg-gray-950 px-6">
      <div className="w-full max-w-sm space-y-6">
        <div className="flex flex-col items-center">
          ...
          <div className="mt-4 h-6 w-32 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
          <div className="mt-2 h-4 w-48 bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
        </div>
        ...
        <div className="h-4 w-40 mx-auto bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse" />
      </div>
    </div>
  );
}
