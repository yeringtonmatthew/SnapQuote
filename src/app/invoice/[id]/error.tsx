...
export default function InvoiceError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-gray-100 dark:bg-gray-950 px-6">
      <div className="text-center">
        ...
        <h1 className="text-[20px] font-bold text-gray-900 dark:text-white">Unable to load invoice</h1>
        <p className="mt-2 max-w-sm text-[14px] leading-relaxed text-gray-500 dark:text-gray-400">
          We couldn&apos;t load this invoice. It may have been removed or the link may be incorrect.
        </p>
