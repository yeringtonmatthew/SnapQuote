...
const BUILT_IN_TEMPLATES: QuoteTemplate[] = [
  ...
  },
  {
    ...
    lineItems: [
      makeLineItem('Installation of synthetic underlayment over entire roof deck'),
      makeLineItem('Installation of 1x4 furring strips for metal panel attachment'),
      makeLineItem('Installation of Big Dog Mighty Metal Roofing System panels'),
      ...
      makeLineItem('Installation of pipe boot flashing and sealant at all roof penetrations'),
      makeLineItem('Complete cleanup, magnetic nail sweep, and haul-away of all debris'),
    ],
    defaultNotes:
      'The Big Dog Mighty Metal Roofing System provides superior weather protection with a 40+ year lifespan. Panels are installed over furring strips for proper ventilation and thermal performance. All materials carry manufacturer warranty.',
  },
  {
