    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={[styles.header, { borderBottomColor: bc }]}>
          ...
          <View>
            <Text style={styles.quoteLabel}>{customerQuoteLabel.toUpperCase()}</Text>
            <Text style={styles.quoteMeta}>Reference {quote.quote_number ? quoteNumber : `#${quoteNumber}`}</Text>
        ...
        <View style={styles.footer} fixed>
          <Text style={styles.footerText}>
            {profile.business_name || profile.full_name} — {customerQuoteLabel}
          </Text>
